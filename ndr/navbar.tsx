  ...
  return (
    <>
      ...
      <div className="hidden md:block">
        ...
        <div className="bg-white px-10 xl:px-22 xl:py-7 py-6 xl:px-32">
          <div className="mx-auto flex justify-between items-center">
            ...
            <button
              className="flex flex-row items-center gap-2 rounded-sm text-sm lg:text-base xl:text-lg px-4 lg:px-5 py-3 font-bold font-inter cursor-pointer bg-red  text-white transition-all duration-300 hover:bg-blue"
            >
              <Image
                src="/desktop.svg"
                alt="Phone"
