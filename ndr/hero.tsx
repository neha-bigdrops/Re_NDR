...
export default function Hero() {
  ...
  return (
    <div
      className="hero-section relative w-full h-full p-4 py-8 md:p-8 md:py-20 lg:p-10 lg:py-23 xl:p-27 xl:px-32"
      style={{
        background:
      ...
      <div className="container mx-auto">
        <div className="hero-content  w-full flex flex-col items-center justify-center md:flex-row md:items-start md:justify-start gap-5 text-center">
          <div className="hero-container relative z-10 flex flex-col items-center justify-center md:items-start md:justify-start gap-5 xl:gap-7 text-center">
            ...
            <div className="partner-container md:mt-13 lg:mt-15 xl:mt-18 w-full flex  items-center justify-center md:justify-start  md:gap-6 lg:gap-8 xl:gap-10 gap-5">
            ...
            <div className="hero-form bg-white p-[25px] pt-[35px] md:pt-[28px] md:pb-[15px] rounded-lg shadow-[0_4px_20px_0_rgba(0,40,104,0.15)] flex flex-col items-center justify-center gap-2 lg:gap-3">
              ...
              <Form {...form}>
                <form onSubmit={handleFormSubmit} className="">
                      ...
                      <FormItem>
                        <FormControl>
                          <input
                            {...field}
                            type="text"
                            className={`w-full text-xs font-nunito lg:text-sm xl:text-base px-3 py-3 lg:text-sm mb-2 xl:mb-3 rounded-[5px] placeholder:text-[#999999] transition-colors duration-200 ${
                  ...
                  <Button
                    type="submit"
                    className="submit-btn w-full rounded-[6px] text-sm md:text-sm lg:text-base xl:text-[1.1rem] font-semibold bg-red font-inter text-white px-5 py-5.5 md:py-5.5 2xl:py-6 relative overflow-hidden transition-all duration-300 ease-in-out z-10 hover:bg-blue cursor-pointer "
                  >
                    <span className=" ">
                  ...
                  <div
                    className="disclaimer mt-3 xl:mt-4 font-inter flex items-start justify-start gap-2 lg:gap-2.5 xl:text-[0.75rem] mt-2 mb-3 md:mb-0 xl:mt-3 xl:mb-5"
                  >
                    <div className="icon">
                      <img
                        src="/tick.svg"
