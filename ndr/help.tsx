    ...
    return (
      ...
      >
        <div className='container mx-auto'>
          <div className='content w-full flex flex-col items-center justify-center md:items-start md:justify-start gap-8 md:gap-10 lg:gap-13 xl:gap-15'>
            <div className="title-container   text-center flex flex-col items-center justify-center md:items-start md:justify-start  gap-4 md:gap-4">
              <div className="title">
                <h2
